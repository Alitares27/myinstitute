  ...
  return (
    <div className={`sidebar ${isMenuOpen ? "open" : ""}`}>
      <div className="sidebar-header">
        <Link to="/panel" className="sidebar-logo" onClick={() => setIsMenuOpen(false)}>
          <img
            src="/temple.webp"
            alt="Logo"
            className="logo-icon"
          ...
          <ul>
            ...
            <li>
              ...
              {isLeadershipOpen && (
                <ul className="submenu" style={{ paddingLeft: "20px", listStyle: "none" }}>
                  ...
                  <li>
                    <NavLink to="/consejos" className="sidebar-link" onClick={() => setIsMenuOpen(false)}>
                  ...
                  <li><NavLink to="/actividades" className="sidebar-link" onClick={() => setIsMenuOpen(false)}><div className="icon-circle"><IoCalendarOutline className="icon" /></div><span>Actividades</span></NavLink></li>
            ...
            {role === "admin" && (
              <li>
                ...
                {isMaintenanceOpen && (
                  <ul className="submenu" style={{ paddingLeft: "20px", listStyle: "none" }}>
                    <li><NavLink to="/usuarios" className="sidebar-link" onClick={() => setIsMenuOpen(false)}><div className="icon-circle"><IoPersonOutline className="icon" /></div><span>Miembros</span></NavLink></li>
                    <li><NavLink to="/templos" className="sidebar-link" onClick={() => setIsMenuOpen(false)}><div className="icon-circle"><IoBusinessOutline className="icon" /></div><span>Templos</span></NavLink></li>
                  </ul>
                )}
              </li>
            )}
